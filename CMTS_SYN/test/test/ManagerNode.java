...
/**
 * In this example of Manager Node. It first creates a cache. For each member of Distributed System it retrieves RegionMXBeand and use its data.
 *   
...
public class ManagerNode {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Cache cache = new CacheFactory()
                  ...
                  .set("cache-xml-file", "Managed-node.xml").create(); 
